...
export const maps = require('./maps/maps.json');

export const mapsArr = Object.values(maps);

export const callsignPositions = (map, waypoints, width, height) => {
...
export const setCallsigns = (map, waypoints) => Object.assign({}, waypoints, { [map.airport.callsign]: map.airport },
