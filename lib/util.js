...
export const dist = (pos1, pos2) => Math.sqrt(Math.pow(Math.abs(pos2.x - pos1.x), 2) + Math.pow(Math.abs(pos2.y - pos1.y), 2));

export const distSq = (pos1, pos2) => Math.pow(Math.abs(pos2.x - pos1.x), 2) + Math.pow(Math.abs(pos2.y - pos1.y), 2);
