  ...
  render() {
    return (
      <div className="settings">
        ...
        <button onClick={this.handleAppearanceExpanded}>{this.state.appearanceExpanded
          ? <span><FaCompress /> Hide appearance settings</span>
          : <span><FaExpand /> Show appearance settings </span>}</button>
        <div style="border: 1px solid #1e606b; border-radius: 5px; padding: 5px;" className={this.state.appearanceExpanded ? null : 'hidden'}>
          <div className="mb SwitchInput">
          ...
          <div className="mb ColorInput">
            ...
            <input type="color" value={SettingsStore.inboundTrafficColor} onInput={this.handleChange('inboundTrafficColor')} />
          </div>
          <div className="mb ColorInput">
            <span>Enroute traffic color:</span>
            <input type="color" value={SettingsStore.enrouteTrafficColor} onInput={this.handleChange('enrouteTrafficColor')} />
          </div>
          <div className="mb ColorInput">
            <span>Outbound traffic color:</span>
            <input type="color" value={SettingsStore.outboundTrafficColor} onInput={this.handleChange('outboundTrafficColor')} />
          </div>
          <div className="mb ColorInput">
            <span>VFR traffic color:</span>
            <input type="color" value={SettingsStore.vfrTrafficColor} onInput={this.handleChange('vfrTrafficColor')} />
          </div>
          <div className="mb ColorInput">
            <span>Path color:</span>
            <input type="color" value={SettingsStore.pathVisualizerColor} onInput={this.handleChange('pathVisualizerColor')} />
          </div>
          <div className="mb ColorInput">
            <span>Climb color:</span>
            <input type="color" value={SettingsStore.climbColor} onInput={this.handleChange('climbColor')} />
          </div>
          <div className="mb ColorInput">
            <span>Descend color:</span>
            <input type="color" value={SettingsStore.descendColor} onInput={this.handleChange('descendColor')} />
          </div>
          <div className="mb ColorInput">
            <span>MSA color:</span>
            <input type="color" value={SettingsStore.msaColor} onInput={this.handleChange('msaColor')} />
          </div>
        </div>
        ...
        <div style="border: 1px solid #1e606b; border-radius: 5px; padding: 5px;" className={this.state.expanded ? null : 'hidden'}>
          ...
          <div className="takeoff-in-order mb SwitchInput">
            ...
            <label class="switch">
              <input type="checkbox" onInput={this.handleCheckboxChange('goArounds')} checked={SettingsStore.goArounds} />
              <span class="slider"></span>
            </label>
          </div>
          <div className="takeoff-in-order mb SwitchInput">
          ...
          <div className="takeoff-in-order mb SwitchInput" title="Use millibars instead of inches of mercury for the airport altimeter">
            <span>Millibars</span>
            <label class="switch">
              <input type="checkbox" onInput={this.handleCheckboxChange('millibars')} checked={SettingsStore.millibars} />
              <span class="slider"></span>
            </label>
          </div>
          <div className="takeoff-in-order mb SwitchInput">
          ...
          <div className="takeoff-in-order mb SwitchInput">
            ...
            <label class="switch">
              <input type="checkbox" onInput={this.handleCheckboxChange('useTextCmd')} checked={SettingsStore.useTextCmd} />
              <span class="slider"></span>
            </label>
          </div>
        </div>
